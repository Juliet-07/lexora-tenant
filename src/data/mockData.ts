export interface Client {
  ...
  status: "Active" | "Pending" | "Under Review" | "Rejected";
  email: string;
  phone: string;
  dateAdded: string;
...
export const clients: Client[] = [
  { id: "CLT-001", name: "Meridian Holdings Ltd", type: "Corporate", riskLevel: "Low", status: "Active", email: "contact@meridianholdings.com", phone: "+44 20 7946 0958", dateAdded: "2025-11-15", assignedOfficer: "Sarah Chen", industry: "Financial Services", country: "United Kingdom" },
  { id: "CLT-002", name: "James Richardson", type: "Individual", riskLevel: "Medium", status: "Active", email: "j.richardson@email.com", phone: "+1 212 555 0134", dateAdded: "2025-12-03", assignedOfficer: "Michael Torres", country: "United States" },
  { id: "CLT-003", name: "Apex Ventures Group", type: "Corporate", riskLevel: "High", status: "Under Review", email: "legal@apexventures.io", phone: "+971 4 555 8842", dateAdded: "2026-01-22", assignedOfficer: "Sarah Chen", industry: "Investment Management", country: "UAE" },
  { id: "CLT-004", name: "Elena Kowalski", type: "Individual", riskLevel: "Low", status: "Active", email: "elena.k@email.com", phone: "+49 30 555 7721", dateAdded: "2026-02-10", assignedOfficer: "David Park", country: "Germany" },
  { id: "CLT-005", name: "Nordic Shipping AS", type: "Corporate", riskLevel: "Medium", status: "Pending", email: "ops@nordicshipping.no", phone: "+47 22 55 33 00", dateAdded: "2026-03-05", assignedOfficer: "Michael Torres", industry: "Logistics", country: "Norway" },
  { id: "CLT-006", name: "Tanaka Enterprises", type: "Corporate", riskLevel: "Low", status: "Active", email: "info@tanaka-ent.jp", phone: "+81 3 5555 0199", dateAdded: "2025-09-18", assignedOfficer: "David Park", industry: "Technology", country: "Japan" },
  { id: "CLT-007", name: "Isabelle Moreau", type: "Individual", riskLevel: "High", status: "Under Review", email: "i.moreau@email.fr", phone: "+33 1 55 55 78 90", dateAdded: "2026-03-28", assignedOfficer: "Sarah Chen", country: "France" },
  { id: "CLT-008", name: "Greenfield Capital Partners", type: "Corporate", riskLevel: "Medium", status: "Active", email: "compliance@greenfieldcp.com", phone: "+1 415 555 2200", dateAdded: "2025-10-01", assignedOfficer: "Michael Torres", industry: "Private Equity", country: "United States" },
];

export const projects: Project[] = [
  { id: "PRJ-001", name: "Annual Audit 2026", clientId: "CLT-001", clientName: "Meridian Holdings Ltd", status: "In Progress", progress: 65, deadline: "2026-05-15", assignedTeam: ["Sarah Chen", "David Park"], hoursLogged: 120, hoursEstimated: 200 },
  { id: "PRJ-002", name: "Tax Advisory", clientId: "CLT-002", clientName: "James Richardson", status: "Planning", progress: 15, deadline: "2026-06-30", assignedTeam: ["Michael Torres"], hoursLogged: 12, hoursEstimated: 80 },
  { id: "PRJ-003", name: "Due Diligence Review", clientId: "CLT-003", clientName: "Apex Ventures Group", status: "On Hold", progress: 40, deadline: "2026-04-30", assignedTeam: ["Sarah Chen", "Ana Rodriguez"], hoursLogged: 56, hoursEstimated: 150 },
  { id: "PRJ-004", name: "Regulatory Compliance", clientId: "CLT-006", clientName: "Tanaka Enterprises", status: "In Progress", progress: 80, deadline: "2026-04-20", assignedTeam: ["David Park"], hoursLogged: 95, hoursEstimated: 120 },
  { id: "PRJ-005", name: "Corporate Restructuring", clientId: "CLT-008", clientName: "Greenfield Capital Partners", status: "In Progress", progress: 30, deadline: "2026-07-31", assignedTeam: ["Michael Torres", "Ana Rodriguez", "Sarah Chen"], hoursLogged: 45, hoursEstimated: 300 },
];

export const teamMembers: TeamMember[] = [
  { id: "TM-001", name: "Sarah Chen", role: "Senior Compliance Officer", avatar: "SC", workload: 85, activeProjects: 3, email: "s.chen@firm.com" },
