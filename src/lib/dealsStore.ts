...
function seedLegal(): LegalDoc[] {
  const src = "Lexora Legal Desk";
  return [
    { id: "lg_1", category: "Statute", title: "Companies Act No. 17/2018", practiceArea: "Company Law", jurisdiction: "Rwanda", source: src, reference: "Law No. 17/2018 of 13/04/2018", summary: "Governs incorporation, governance, and dissolution of companies in Rwanda.", content: "The Companies Act consolidates the rules on incorporation, share capital, directors' duties, shareholder remedies, corporate restructuring and winding up. Key areas for practitioners: Part III (directors and governance), Part VI (mergers and amalgamations) and Part IX (insolvency interface). Recent practice notes emphasise beneficial ownership filings at registration and on every change of control.", publishedAt: now(), updatedAt: now() },
    { id: "lg_2", category: "Regulation", title: "BNR Directive on Bank Mergers", practiceArea: "Banking/Financial", jurisdiction: "Rwanda", source: src, reference: "BNR Directive No. 04/2021", summary: "Prior approval requirements for bank M&A transactions.", content: "Any acquisition of 5% or more of the shares of a licensed bank requires prior written approval of the central bank. The directive sets out the application dossier (fit and proper documentation, funding source declarations, post-merger capital plan) and a 90-day review window. Completion before approval is void and attracts administrative penalties.", publishedAt: now(), updatedAt: now() },
    { id: "lg_3", category: "Case Law", title: "Kigali Holdings v. RIB [2023]", practiceArea: "Company Law", jurisdiction: "Rwanda", source: src, reference: "[2023] RCC 118", summary: "Directors' duties under s.170 — landmark ruling on business judgment rule.", content: "The Commercial Court held that a director who acts on informed advice, in good faith and without personal interest is shielded from liability even where the decision produces a loss. The judgment imports a business judgment standard into Rwandan company law and sets out a four-limb test: informed basis, good faith, absence of conflict, rational belief in the company's interest.", publishedAt: now(), updatedAt: now() },
    { id: "lg_4", category: "International", title: "OECD Transfer Pricing Guidelines", practiceArea: "Tax", jurisdiction: "International", source: src, summary: "Arm's length principle application across cross-border deals.", content: "The Guidelines set the arm's length standard for intra-group pricing, comparability analysis, and documentation (master file, local file, country-by-country report). Deal teams should map intercompany agreements early in diligence and test whether the target's pricing policy is documented contemporaneously.", publishedAt: now(), updatedAt: now() },
    { id: "lg_5", category: "Update", title: "CMA Rule Change — Disclosure Thresholds", practiceArea: "Capital Markets", jurisdiction: "Rwanda", source: src, summary: "Beneficial ownership disclosure lowered to 3% effective Q3 2026.", content: "The Capital Market Authority has lowered the substantial shareholding disclosure threshold from 5% to 3% for all listed issuers. Notifications must be filed within two business days of crossing the threshold, and issuers must maintain a public register of substantial holders. Existing holders above 3% must file a baseline notification within 30 days of commencement.", publishedAt: now(), updatedAt: now() },
    { id: "lg_6", category: "Update", title: "FATF Recommendation 24 Refresh", practiceArea: "AML/CFT", jurisdiction: "International", source: src, summary: "Updated guidance on beneficial ownership transparency.", content: "Recommendation 24 now requires countries to hold adequate, accurate and up-to-date beneficial ownership information in a public or competent-authority register, with a multi-pronged approach combining registry, company-held and alternative sources. Expect downstream changes to local registrar filing obligations and to onboarding evidence standards.", publishedAt: now(), updatedAt: now() },
    { id: "lg_7", category: "Commentary", title: "Practice Note: Cross-Border M&A in EAC", practiceArea: "Company Law", jurisdiction: "East Africa", source: src, summary: "Internal briefing on regional considerations.", content: "A practical walkthrough of merger control across EAC member states: the COMESA Competition Commission one-stop filing, national thresholds that still bite, foreign exchange approvals, and sector regulators that retain veto rights. Includes an indicative timetable for a two-jurisdiction deal.", publishedAt: now(), updatedAt: now() },
  ];
}
