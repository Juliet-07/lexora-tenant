...
export default function ClientProfile() {
    ...
    switch (check.id) {
      ...
      case "pep":
        return isHighRisk
          ? {
              ...
              status: "flagged",
              result: "Match found",
              detail: "Possible match with PEP — manual review required",
            }
          : {
              ...check,
              status: "passed",
      ...
      case "ubo":
        return client.type === "Corporate"
          ? {
              ...check,
              status: isHighRisk ? "flagged" : "passed",
              result: isHighRisk ? "Complex structure" : "Identified",
              detail: isHighRisk
      ...
      case "adverseMedia":
        return isHighRisk
          ? {
              ...
              detail:
                "Adverse coverage from credible sources in last 24 months",
            }
          : {
              ...check,
              status: "passed",
  ...
  const runAllVerifications = async () => {
    ...
    toast({
      ...
      description: "Review results before approving the client.",
    });
  };
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue={canRunVerifications ? "verifications" : "overview"}>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{client.assignedOfficer}</span>
                </div>
                <div className="flex justify-between">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    className={kycColor[client.kycStatus || "Not Started"]}
                  >
        ...
        <TabsContent value="verifications" className="mt-4 space-y-4">
          {!canRunVerifications && (
            <Alert>
              ...
              <AlertDescription>
                Verifications can only be run when the client has submitted
                their KYC documents. Current status:{" "}
              ...
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Run regulatory checks (CDD/EDD, UBO, sanctions, PEP, adverse
                    media, risk scoring) before activating this client.
                  </p>
                </div>
                <Button
            ...
            <CardContent className="space-y-4">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2 flex-wrap">
                          ...
                          <Badge
                            className={`text-xs ${statusBadge[check.status]}`}
                          >
              ...
              {completed && flaggedCount > 0 && (
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    for review. Conduct EDD or request additional documentation
                    before approving.
                  </AlertDescription>
                </Alert>
              )}
              ...
              {completed && flaggedCount === 0 && (
                <Alert className="border-success/30 bg-success/5">
                  ...
                  <AlertDescription>
                    Client is cleared for activation. You may now approve
                    onboarding.
                  </AlertDescription>
                </Alert>
              )}
        ...
        <TabsContent value="kyc" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">KYC Review History</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                  <div>
                    <p className="text-sm font-medium">PEP Screening</p>
                    <p className="text-xs text-muted-foreground">
                      Database scan
                    </p>
                  </div>
